...
const defaults = {
  ...
  store: {
    ...
    defaultState: "",
    status: "active",
    closedMessage: "Loja temporariamente fechada.",
    currency: "BRL",
  ...
  gateway_names: { enabled: false, names: [], dedupe: true },
  appearance: { badges: [], reviews: [], faq: [], footerText: "" },
  integrations: {
    utmifyToken: "",
    utmifyEnabled: false,
    sendPending: true,
  ...
  system: { maintenance: false, backupEnabled: false, securityLevel: "standard" },
  offers: [
